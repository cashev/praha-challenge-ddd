...
CREATE TABLE "TaskStatus" (
    ...
    "taskStatusMstId" INTEGER NOT NULL,

    CONSTRAINT "TaskStatus_pkey" PRIMARY KEY ("id")
);

-- CreateTable
CREATE TABLE "TaskStatusMst" (
    "id" SERIAL NOT NULL,
    "name" TEXT NOT NULL,

    CONSTRAINT "TaskStatusMst_pkey" PRIMARY KEY ("id")
);
...
-- AddForeignKey
ALTER TABLE "TaskStatus" ADD CONSTRAINT "TaskStatus_taskStatusMstId_fkey" FOREIGN KEY ("taskStatusMstId") REFERENCES "TaskStatusMst"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
