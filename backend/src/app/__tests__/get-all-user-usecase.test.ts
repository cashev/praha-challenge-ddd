...
describe('do', () => {
  const u1 = new UserDto({ id: 1, name: '永野 哲哉', email: 'tty-ngn19800814@dion.ne.jp' });
  const u2 = new UserDto({ id: 2, name: '江口 隆吉', email: 'egt572@asp.home.ne.jp' });
  const u3 = new UserDto({ id: 3, name: '柳沢 朋美', email: 'tmmyngsw@ybb.ne.jp' });
